...
<body>
    ...
    <div class="table-block">
        ...
        <div class="table-row">
            ...
            <div class="table-cell"><span class="underline" style="text-align: center; font-weight: bold;">{{ $controlTotalQty ?? null }}</span></div>
        </div>
    </div>
        ...
        <tr>
            ...
            <td style="width: 40%; vertical-align: top; padding-right: 8px;">
                <div style="padding: 1px; border: 1px solid black;">
                    <label class="bold" style="font-size: 10px; padding-left: 1px;">1ST GBDP COATING INFORMATION</label>
            ...
            <td style="width: 40%; vertical-align: top;">
                <div style="padding: 1px; border: 1px solid black;">
                    <label class="bold" style="font-size: 10px; padding-left: 1px;">2ND GBDP COATING INFORMATION</label>
