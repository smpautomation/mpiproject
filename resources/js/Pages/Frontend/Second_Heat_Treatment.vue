<template>
    <Frontend>
        <div
            class="flex flex-col items-center justify-center min-h-screen px-4 py-2 bg-gray-100"
        >
            <div class="flex flex-row space-x-8 whitespace-nowrap">
                <div class="w-full max-w-4xl mb-12">
                    ...
                    >
                        <!-- Header -->
                        <h2
                            class="pb-3 mb-5 text-xl font-semibold tracking-wide text-gray-800 border-b border-gray-200"
                        >
                            Options
                        </h2>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                ...
                                >
                                    This button allows data to be fetched
                                    automatically for
                                    <span class="font-semibold text-gray-800"
                                        >1st GBDP</span
                                    >. Use this option when you want the system
                                    <br />
                                    to retrieve relevant information without
                                    manual input.
                                </p>
                                <button
                                    @click="autoFetch"
                                ...
                                <input
                                    ...
                                    "
                                    placeholder="e.g. K-40 (furnace)"
                                    class="ml-5 w-[8rem] text-xs border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                />
                                <input
                                    ...
                                    "
                                    placeholder="e.g. 101ST (mass prod)"
                                    class="ml-5 w-[9.5rem] text-xs border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                />
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-full max-w-4xl mb-12">
                    <div
                        class="px-6 py-6 bg-white border border-gray-200 shadow-xl rounded-2xl"
                    >
                        <!-- Header -->
                        <div class="mb-5">
                            <h2
                                class="text-xl font-bold tracking-wide text-gray-800"
                            >
                                Heat Treatment Information
                            </h2>
                            <!-- Left-aligned accent bar under the title -->
                            <div
                                class="mt-1 h-1 w-40 rounded-full bg-gradient-to-r from-teal-500 to-cyan-400 shadow-[0_0_6px_rgba(34,211,238,0.6)]"
                            ></div>
                        </div>
                        <!-- Body -->
                        <div class="flex flex-row space-x-5">
                            <div>
                                <label
                                    class="block mb-1 text-xs font-semibold text-gray-700"
                                >
                                    Selected Furnace
                                </label>
                                <span
                                    class="px-2 py-1 text-sm font-semibold text-teal-700 border border-teal-200 rounded-md shadow-sm bg-teal-50"
                                >
                                    {{ selectedFurnace }}
                                </span>
                            </div>
            ...
            <div class="flex flex-col w-full max-w-6xl gap-8 md:flex-row">
                <!-- 1ST GBDP -->
                <div
                    class="flex-1 px-6 py-6 bg-white border border-gray-200 shadow-xl rounded-2xl"
                >
                    <h2
                        class="pb-2 mb-4 text-lg font-bold text-gray-800 border-b"
                    >
                        1ST GBDP
                    </h2>
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                >
                                <input
                                    v-model="gbdp_1st.furnaceNo"
                                    type="text"
                                    @input="
                                        gbdp_1st.furnaceNo =
                                            gbdp_1st.furnaceNo.toUpperCase()
                                    "
                            ...
                            <div>
                                ...
                                >
                                <input
                                    v-model="gbdp_1st.batchCycleNo"
                                    type="text"
                                    @input="
                                        gbdp_1st.batchCycleNo =
                                            gbdp_1st.batchCycleNo.toUpperCase()
                                    "
                                    class="w-full text-xs border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                >
                                <input
                                    v-model="gbdp_1st.cyclePattern"
                                    type="text"
                                    @input="
                                        gbdp_1st.cyclePattern =
                                            gbdp_1st.cyclePattern.toUpperCase()
                                    "
                                    class="w-full text-xs border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                />
                            </div>
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                >
                                <input
                                    v-model="gbdp_1st.cycleNo"
                                    type="text"
                                    @input="
                                        gbdp_1st.cycleNo =
                                            gbdp_1st.cycleNo.toUpperCase()
                                    "
                                    class="w-full text-xs border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                >
                                <input
                                    v-model="gbdp_1st.currentPattern"
                                    type="text"
                                    @input="
                                        gbdp_1st.currentPattern =
                                            gbdp_1st.currentPattern.toUpperCase()
                                    "
                                    class="w-full text-xs border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                />
                            </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                >
                                <input
                                    v-model="gbdp_2nd.furnaceNo"
                                    type="text"
                                    disabled
                                    class="w-full text-xs bg-gray-100 border-gray-300 rounded-lg shadow-sm cursor-not-allowed"
                                />
                            </div>
                            <div>
                                <label
                        ...
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                >
                                <input
                                    v-model="gbdp_2nd.currentPattern"
                                    type="text"
                                    disabled
                                    class="w-full text-xs bg-gray-100 border-gray-300 rounded-lg shadow-sm cursor-not-allowed"
                                />
...
const getCurrentMassProdData = async () => {
    try {
        ...
        if (!massProdData) {
            toast.error(
                `No data found for Mass Production: ${selectedMassProd.value}`,
            );
            return;
        }
        ...
        toast.success(
            `Data fetched successfully for ${selectedMassProd.value} Mass Production`,
        );
    } catch (error) {
...
const autoFetch = async () => {
    ...
    try {
        const response = await axios.get(
            `/api/mass-production/${selectedFurnace_fetch.value}/${selectedMassProd_fetch.value}`,
        );
        const massProdData = response.data;
        if (!massProdData) {
            toast.error(
                `No data found for Mass Production: ${selectedMassProd_fetch.value}`,
            );
            return;
        }
        ...
        if (error.response) {
            if (error.response.status === 404) {
                toast.error(
                    `Mass Production "${selectedMassProd_fetch.value}" does not exists.`,
                );
            } else {
                toast.error(
...
const addtnl_saveToDatabase = async () => {
    ...
    try {
        const response = await axios.post(
            `/api/break-lot-second-heat-treatment`,
            dataPayload,
        );
...
const updateFormatType = async () => {
    ...
    const layerKey =
        selectedLayer.value === "9.5"
            ? "layer_9_5_format_type"
            : `layer_${selectedLayer.value}_format_type`;
