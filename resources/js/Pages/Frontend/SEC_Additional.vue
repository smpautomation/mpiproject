        ...
        <div class="absolute inset-0 z-0 bg-black bg-opacity-30"></div>
            ...
            <div v-show="showGraphAndTables" class="z-10 flex flex-col">
                ...
                <div class="flex items-center justify-center mt-10">
                    ...
                    <button @click="router.visit('/reports')" class="flex items-center gap-2 px-4 py-2 ml-10 font-semibold text-white transition duration-300 rounded shadow-md bg-cyan-600 hover:bg-cyan-700">
