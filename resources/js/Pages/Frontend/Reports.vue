        ...
        >
            ...
            >
                <div v-if="serialList.length == 0">
                    <!-- default div -->
                    <div
                        class="flex flex-col items-center justify-center mt-10 align-baseline"
                    >
                        <div
                        ...
                        ></div>
                        <p class="text-xl text-center animate-pulse">
                            (No data available yet) <br />
                            Please ensure that the data is created in the Manage
                            section of the website before proceeding.
                        </p>
                    </div>
                </div>
            </div>
            <div
                v-if="showNotif2 && isFromApproval"
                class="flex flex-row items-center justify-center px-4 py-2 my-10 text-white bg-yellow-500 shadow-lg rounded-2xl"
            >
            ...
            -->
                ...
                <div
                    ...
                    class="p-4 mt-4 text-red-700 bg-red-100 border border-red-400 rounded"
                >
                    {{ reportErrorMessage }}
                </div>
                ...
                >
                    <div
                        class="flex flex-row w-full max-w-4xl px-4 mx-auto mb-10"
                    >
                        <div
                            v-if="
                                state.user &&
                                state.user.employee_id === '005009'
                            "
                        ...
                        >
                            ...
                            <p class="text-xl font-bold whitespace-nowrap">
                                {{ greetingsWindowFirstName }}
                                {{ greetingsWindowLastName }} san
                            </p>
                            <p
                                v-if="state.user"
                                class="text-xs text-blue-800 animate-pulse"
                            >
                                [{{ state.user.access_type }}]
                            </p>
                            <p v-if="report_isFinalized == true">
                                FINALIZED
                                <span>
                                    <svg
                                    ...
                                    >
                                        ...
                                        <path
                                            fill="#fff"
                                            d="M10 14.5l-2.5-2.5-1.4 1.4L10 17.3l7.9-7.9-1.4-1.4z"
                                        />
                                    </svg>
                                </span>
                            </p>
                        ...
                        >
                            ...
                            <p
                                v-if="report_isFinalized == true"
                                class="flex items-center gap-2 p-2 text-sm font-extrabold text-green-400 bg-green-100 rounded-lg"
                            >
                                FINALIZED
                        ...
                        >
                            ...
                            <div class="flex flex-col">
                                <div
                                    v-show="showCarMarkButton && !isAutomotive"
                                    class="items-center p-1 text-center border-4 border-white"
                                >
                                    <button
                                        disabled
                                    ...
                                    >
                                        <span
                                            class="inline-block text-sm transition-all duration-300 ease-in-out transform text-md group-hover:scale-110 group-hover:opacity-90"
                                        >
                                            NON-AUTOMOTIVE
                                        </span>
                                    </button>
                    ...
                    >
                        ...
                        <div class="flex flex-col mb-4 space-y-4">
                            ...
                            <div class="flex flex-row gap-4 justify-evenly">
                                ...
                                <div class="flex flex-col w-[12rem]">
                                    ...
                                    <input
                                        ...
                                        @input="
                                            reportShift_OvenInfo =
                                                reportShift_OvenInfo.toUpperCase()
                                        "
                                        type="text"
                                        name="ovenInfo_shift"
                                        id="ovenInfo_shift"
                            ...
                            <!-- Row 2 -->
                            <div
                                class="flex flex-row gap-4 mt-4 justify-evenly"
                            >
                                <!-- Date -->
                                <div class="flex flex-col w-[12rem]">
                                    <label
                                ...
                                <div class="flex flex-col w-[12rem]">
                                    ...
                                    <input
                                        ...
                                        @input="
                                            reportTimeUnloading =
                                                reportTimeUnloading.toUpperCase()
                                        "
                                        type="text"
                                        name="timeUnloading"
                                        id="timeUnloading"
                                ...
                                <div class="flex flex-col w-[12rem]">
                                    <label
                                        for="temperature_TimeUnloading"
                                        class="text-[13px] font-medium text-gray-700 mb-1"
                                    >
                                        Temperature (Time Unloading):
                                    </label>
                                    <input
                                        v-model="
                                            reportTemperature_TimeUnloading
                                        "
                                        type="text"
                                ...
                                <div class="flex flex-col w-[12rem]">
                                    ...
                                    <input
                                        ...
                                        @input="
                                            reportOperator_OvenInfo =
                                                reportOperator_OvenInfo.toUpperCase()
                                        "
                                        type="text"
                    ...
                    <div
                        class="p-5 mx-10 border-2 border-white rounded-lg shadow-xl"
                    >
                        <p class="mb-2 text-xl font-semibold text-gray-700">
                            Magnetic Property Inspection Information
                        </p>
                        ...
                        <div class="flex flex-row gap-4 mt-4 justify-evenly">
                            ...
                            <div class="flex flex-col w-[12rem]">
                                ...
                                <input
                                    v-model="reportShift"
                                    @input="
                                        reportShift = reportShift.toUpperCase()
                                    "
                                    type="text"
                                    name="reportShift"
                                    id="reportShift"
                        ...
                        >
                            <table
                                class="mt-[1.1rem] border-collapse table-auto border-4 border-white"
                            >
                                <thead>
                                    <tr class="bg-blue-400">
                                        <th
                                            colspan="2"
                                            class="px-2 py-2 text-lg font-semibold text-center text-white"
                                        >
                                            STANDARD&nbsp;SAMPLE&nbsp;DIMENSION&nbsp;and&nbsp;Material&nbsp;Grade<br />標準サンプル寸法および材料グレード
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td
                                            class="px-4 py-1 text-blue-600 border-4 border-white"
                                        >
                                            LENGTH&nbsp;(mm)
                                        </td>
                                        <td
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            class="px-4 py-1 text-blue-600 border-4 border-white"
                                        >
                                            {{ inspectionMpiSampleQty }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            <table
                                class="ml-2 mt-[1rem] border-collapse table-auto border-4 border-white"
                            >
                                <thead>
                                    <tr class="bg-blue-400">
                                        <th
                                            colspan="7"
                                            class="py-4 text-lg font-semibold text-center text-white border-4 border-white"
                                        >
                                            MAGNETIC&nbsp;PROPERTY&nbsp;DATA(磁気特性データ)
                                        </th>
                                    </tr>
                                    <tr class="bg-blue-300">
                                        ...
                                        <th
                                            colspan="5"
                                            class="px-4 text-center text-white border-4 border-white"
                                        >
                                            ACTUAL DATA
                                        </th>
                                    </tr>
                                ...
                                <tbody>
                                    <tr class="text-center">
                                        <td
                                            class="px-4 py-2 text-blue-600 border-4 border-white whitespace-nowrap"
                                        >
                                            Br (G)
                                        </td>
                                        <td
                                    ...
                                    >
                                        ...
                                        >
                                            <span v-if="showGX">GX </span>
                                            <input
                                                type="number"
                                                v-model="reportGX_iHcStandard"
                                                name="stdDev"
                                    ...
                                    <template v-if="showROB">
                                        <tr class="bg-blue-400">
                                            <th
                                                colspan="7"
                                                class="py-1 font-semibold text-center text-white border-4 border-white text-md"
                                            >
                                                BH Tracer Measurement
                                            </th>
                                        </tr>
                                        <tr class="bg-blue-400">
                                            <th
                                        ...
                                        <tr class="text-center">
                                            ...
                                            >
                                                <input
                                                    type="text"
                                                    v-model="reportROB_brMin"
                                                    @input="
                                                        reportROB_brMin =
                                                            reportROB_brMin?.toUpperCase()
                                                    "
                                                    name="robBrMin"
                                                    class="w-[4.5rem] h-[1.5rem] py-[14px] mt-1 text-sm border border-gray-300 rounded-md bg-white text-gray-800 hover:border-blue-400 hover:ring-1 hover:ring-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-white transition duration-200 ease-in-out"
                                                />
                                            ...
                                            >
                                                <input
                                                    type="text"
                                                    v-model="reportROB_brMax"
                                                    @input="
                                                        reportROB_brMax =
                                                            reportROB_brMax?.toUpperCase()
                                                    "
                                                    name="stdDev"
                                                    class="w-[4.5rem] h-[1.5rem] py-[14px] mt-1 text-sm border border-gray-300 rounded-md bg-white text-gray-800 hover:border-blue-400 hover:ring-1 hover:ring-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-white transition duration-200 ease-in-out"
                                                />
                                            ...
                                            >
                                                <input
                                                    type="text"
                                                    v-model="reportROB_iHcMin"
                                                    @input="
                                                        reportROB_iHcMin =
                                                            reportROB_iHcMin?.toUpperCase()
                                                    "
                                                    name="stdDev"
                                                    class="w-[4.5rem] h-[1.5rem] py-[14px] mt-1 text-sm border border-gray-300 rounded-md bg-white text-gray-800 hover:border-blue-400 hover:ring-1 hover:ring-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-white transition duration-200 ease-in-out"
                                                />
                                            ...
                                            >
                                                <input
                                                    type="text"
                                                    v-model="reportROB_iHcMax"
                                                    @input="
                                                        reportROB_iHcMax =
                                                            reportROB_iHcMax?.toUpperCase()
                                                    "
                                                    name="stdDev"
                                                    class="w-[4.5rem] h-[1.5rem] py-[14px] mt-1 text-sm border border-gray-300 rounded-md bg-white text-gray-800 hover:border-blue-400 hover:ring-1 hover:ring-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-white transition duration-200 ease-in-out"
                                                />
                                    ...
                                    <tr
                                        v-show="show1x1x1Data_withoutCorner"
                                        class="text-center bg-blue-300"
                                    >
                                        <td
                                            colspan="2"
                                            class="px-4 py-2 font-extrabold text-white border-4 border-white"
                                        >
                                            Data of 1x1x1 mm samples
                                        </td>
                                        <td
                                            class="px-4 py-2 font-extrabold text-white border-4 border-white"
                                        >
                                        ...
                                        <td
                                            class="px-4 py-2 font-extrabold text-white border-4 border-white whitespace-nowrap"
                                        >
                                        ...
                                        <tr class="text-center">
                                            ...
                                            >
                                                <div class="flex items-center">
                                                    <input
                                                        ...
                                                        class="w-[4.5rem] h-[1.5rem] py-[14px] text-sm border border-gray-300 rounded-md bg-white text-gray-800 hover:border-blue-400 hover:ring-1 hover:ring-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-white transition duration-200 ease-in-out"
                                                    />
                                                    <span
                                            ...
                                            >
                                                ...
                                                <input
                                                    ...
                                                    class="w-[5.5rem] h-[1.5rem] py-[14px] text-sm border border-gray-300 rounded-md bg-white text-gray-800 hover:border-blue-400 hover:ring-1 hover:ring-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-white transition duration-200 ease-in-out"
                                                />
                                                (kOe)
                                            </td>
                                            <td
                                        ...
                                        <tr class="text-center">
                                            ...
                                            >
                                                <div class="flex items-center">
                                                    <input
                                                        type="text"
                                                        v-model="reportBH_data"
                                                        @input="
                                                            reportBH_data =
                                                                reportBH_data.toUpperCase()
                                                        "
                                                        name="stdDev"
                                                        class="w-[4.5rem] h-[1.5rem] py-[14px] mt-1 text-sm border border-gray-300 rounded-md bg-white text-gray-800 hover:border-blue-400 hover:ring-1 hover:ring-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-white transition duration-200 ease-in-out"
                                                    />
                                    ...
                                    <template
                                        v-if="showBHDataSeg && isBhSegFormat"
                                    >
                                        <tr class="text-center">
                                            <th
                                                colspan="2"
                                        ...
                                        <tr class="text-center">
                                            ...
                                            >
                                                <input
                                                    type="number"
                                                    v-model="
                                                        reportBHRTSeg_lower_dataStandard
                                                    "
                                                    name="stdDev"
                                                    class="w-[5.5rem] h-[1.5rem] py-[14px] mt-1 text-sm border border-gray-300 rounded-md bg-white text-gray-800 hover:border-blue-400 hover:ring-1 hover:ring-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-white transition duration-200 ease-in-out"
                                                />
                                                ...
                                                <input
                                                    type="number"
                                                    v-model="
                                                        reportBHRTSeg_higher_dataStandard
                                                    "
                                                    name="stdDev"
                                                    class="w-[5.5rem] h-[1.5rem] py-[14px] mt-1 text-sm border border-gray-300 rounded-md bg-white text-gray-800 hover:border-blue-400 hover:ring-1 hover:ring-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-white transition duration-200 ease-in-out"
                                                />
                                            ...
                                            >
                                                <div class="flex items-center">
                                                    <input
                                                        type="text"
                                                        v-model="
                                                            reportBHSeg_2nd_data
                                                        "
                                                        @input="
                                                            reportBHSeg_2nd_data =
                                                                reportBHSeg_2nd_data.toUpperCase()
                                                        "
                                                        name="stdDev"
                                                        class="w-[4.5rem] h-[1.5rem] py-[14px] mt-1 text-sm border border-gray-300 rounded-md bg-white text-gray-800 hover:border-blue-400 hover:ring-1 hover:ring-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-white transition duration-200 ease-in-out"
                                                    />
                                        ...
                                        >
                                            ...
                                            <button
                                                @click="
                                                    resetReportBHSegData();
                                                    confirmResetSeg = false;
                                                "
                                                class="px-2 py-1 text-xs text-white transition bg-green-600 rounded hover:bg-green-500"
                                            >
                                                Yes
                        ...
                        <div
                            class="flex flex-row items-center justify-center mx-5 mt-5 align-middle"
                        >
                    ...
                    <div
                        class="flex flex-row items-start justify-center p-10 mx-10 mt-10 mb-10 bg-blue-100 border-2 border-white rounded-lg shadow-xl gap-x-10"
                    >
                        <!-- SMP Judgement -->
                        <div class="flex flex-col">
                            <p
                                class="p-2 text-xl font-extrabold text-center text-white bg-blue-400 border-4 border-white whitespace-nowrap"
                            >
                                SMP Judgement
                            </p>
                            <p
                                v-if="modifiedSMPJudgement"
                                class="p-2 text-center border-b-4 border-l-4 border-r-4 border-white"
                            >
                                <span
                            ...
                            <div
                                v-if="
                                    ...
                                    (state.user.access_type ==
                                        ...
                                        state.user.access_type ==
                                            'Automation' ||
                                        state.user.change_judgement_access ==
                                            'yes')
                                "
                            ...
                            >
                                ...
                                <select
                                    v-model="modifiedSMPJudgement"
                                    class="text-blue-700 input text-xs w-[100px] h-[35px]"
                                    required
                                >
                                    <option disabled value="" selected>
                                        Change Judgement
                                    </option>
                                    <option class="text-blue-700" value="HOLD">
                                        HOLD
                                    </option>
                                    <option
                                        class="text-blue-700"
                            ...
                            <div
                                ...
                                "
                                class="p-2 mt-2 text-sm font-extrabold text-blue-500 border-4 border-white"
                            >
                                Origin Judgement: {{ reportSMPJudgement }}
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <div
                                class="items-center p-1 text-center border-b-4 border-l-4 border-r-4 border-white"
                            >
                                <div
                                    v-show="showPreparedByDefault"
                                    class="w-[153px] h-[153px]"
                                >
                                    <span
                                        class="font-semibold text-blue-700 opacity-100 animate-pulse"
                                    >
                                        Waiting for stamp...
                                    </span>
                                </div>
                                ...
                                >
                                    <span
                                        class="inline-block transition-all duration-300 ease-in-out transform group-hover:scale-110 group-hover:opacity-90"
                                    >
                                        Click&nbsp;to&nbsp;Stamp
                                    </span>
                                </button>
                                ...
                                <div
                                    class="flex flex-col px-[11px] py-5 justify-center gap-4"
                                    v-show="preparedByStampConfirmation"
                                >
                                    <button
                            ...
                            <button
                                v-if="
                                    !checkedByStampPhoto && preparedByStampPhoto
                                "
                                @click="openUndoModal('prepared')"
                                class="bg-red-500 rounded-xl shadow-xl text-white font-bold p-2 text-xs mt-6 transition-all duration-200 ease-out hover:bg-red-600 hover:shadow-2xl hover:-translate-y-0.5 active:translate-y-0 active:shadow-lg"
                            >
                        ...
                        <div class="flex flex-col">
                            ...
                            >
                                <div
                                    v-show="showCheckedByDefault"
                                    class="w-[153px] h-[153px]"
                                >
                                    <span
                                        class="font-semibold text-blue-700 opacity-100 animate-pulse whitespace-nowrap"
                                    >
                                        Waiting for stamp...
                                    </span>
                                </div>
                                ...
                                <div
                                    class="flex flex-col px-[11px] py-5 justify-center gap-4"
                                    v-show="checkedByStampConfirmation"
                                >
                                    <button
                                ...
                                >
                                    <span
                                        :class="
                                            getFontSize(
                                                checkedByPerson_firstName,
                                            )
                                        "
                                        >{{ checkedByPerson_firstName }}</span
                                    >
                                    <span class="my-[9px]">{{
                                        reportCheckedByDate
                                    }}</span>
                                    <span
                                        :class="
                                            getFontSize(
                                                checkedByPerson_lastName,
                                            )
                                        "
                                        >{{ checkedByPerson_lastName }}</span
                                    >
                                </span>
                            </div>
                            <button
                                v-if="
                                    !approvedByStampPhoto && checkedByStampPhoto
                                "
                            ...
                            >
                                ...
                                >
                                    <span
                                        :class="
                                            getFontSize(
                                                approvedByPerson_firstName,
                                            )
                                        "
                                        >{{ approvedByPerson_firstName }}</span
                                    >
                                    <span class="my-[9px]">{{
                                    ...
                                    <span
                                        :class="
                                            getFontSize(
                                                approvedByPerson_lastName,
                                            )
                                        "
                                        >{{ approvedByPerson_lastName }}</span
                                    >
                                </span>
                            </div>
                            <button
                        ...
                        <div class="flex flex-col">
                            <p
                                class="p-2 text-xl font-extrabold text-center text-white bg-blue-400 border-4 border-white"
                            >
                                Note: Reason of REJECT/HOLD
                            </p>
                            <div
                                class="p-2 border-4 border-white w-[320px] h-[190px] box-border"
                            >
                                <div
                                    class="flex flex-col items-start w-full h-full overflow-auto bg-blue-100"
                                >
                                    <span
                    ...
                    <div
                        v-show="showNotif3"
                        class="flex flex-row items-center justify-center max-w-xs px-4 py-2 mx-auto mt-10 text-white bg-green-700 rounded-md shadow-lg"
                    >
                        <p class="text-lg font-extrabold text-center">
                            {{ reportNotificationMessage }}
                        </p>
                    ...
                    <div
                        v-if="report_isFinalized"
                        class="relative flex items-center w-full h-10 overflow-hidden text-yellow-700 bg-yellow-100"
                    >
                        <div class="marquee animate-marquee">
                            <span class="mx-8"
                                >This report has already been finalized.</span
                            >
                            <span class="mx-8"
                                >This report has already been finalized.</span
                            >
                    ...
                    <div class="flex flex-col mt-10">
                        ...
                        >
                            ...
                            <!-- Side Content -->
                            <div
                                class="w-[350px] h-[420px] bg-gray-50 rounded-xl border-2 border-blue-900 flex justify-center items-start p-4"
                            >
                                <div
                                ...
                                >
                                    ...
                                    <p class="font-semibold text-red-600">
                                        ...
                                        <template v-else>
                                            ...
                                            >
                                                Reject remarks will appear here
                                                once the report data has been
                                                saved, if any exist.
                                            </span>
                                        </template>
                                    </p>
                        ...
                        >
                            ...
                            <div class="flex flex-row justify-center">
                                <p class="mr-10">
                                    Mias. Employee:
                                    <span>{{ propD_miasEmp }}</span>
                                </p>
                                <p>
                                    Factor Employee:
                                    <span>{{ propD_factorEmp }}</span>
                                </p>
                            </div>
                            <div
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="flex flex-row flex-[3] mb-10 shadow-2xl"
                                    >
                                        <div class="min-w-[700px]">
                                            <table
                                                class="border border-gray-300 table-auto rounded-xl"
                                            >
                                                <thead
                                                    class="text-white bg-gradient-to-r from-blue-700 to-blue-400"
                                                >
                                                    <tr>
                                                        <th
                                                            v-for="tableLayerColumnHeader in tableLayerColumnHeaders"
                                                            :key="
                                                                tableLayerColumnHeader.name
                                                            "
                                                            :colspan="
                                                                tableLayerColumnHeader.colspan
                                                            "
                                                ...
                                                <tbody class="bg-white">
                                                    ...
                                                    >
                                                        <td
                                                            class="whitespace-nowrap px-[3px] py-[3px] text-[10px] text-center text-gray-700 border border-blue-500"
                                                        >
                                                            {{ item.date }}
                                                        </td>
                                                        <td
                                                        ...
                                                        <td
                                                            class="whitespace-nowrap px-[0px] py-[3px] text-[10px] text-center text-gray-700 border border-blue-500"
                                                        >
                                                            {{
                                                                item.furnace_no
                                                            }}
                                                        ...
                                                        <td
                                                            v-if="
                                                                ...
                                                                '1'
                                                            "
                                                            class="whitespace-nowrap px-[2px] py-[3px] text-[10px] text-center border border-blue-500 bg-red-500 text-white"
                                                        >
                                                            E
                                                        </td>
                                                        <td
                                                            v-else
                                                            class="whitespace-nowrap px-[2px] py-[3px] text-[10px] text-center border border-blue-500 text-gray-700"
                                                        >
                                                            {{
                                                                item.remark
                                                                    .Br_remarks ==
                                                        ...
                                                        <td
                                                            class="whitespace-nowrap px-[2px] py-[3px] text-[10px] text-center text-gray-700 border border-blue-500"
                                                        >
                                                            {{ item.iHc }}
                                                        </td>
                                                        <td
                                    ...
                                    <div class="flex flex-row flex-[1]">
                                        <!-- DIV 2 -->
                                        <table
                                            class="border border-gray-300 rounded-lg shadow-2xl table-auto"
                                        >
                                            <thead
                                            ...
                                            >
                                                <tr>
                                                    <th
                                                        class="px-[3px] py-[3px] text-[10px] font-extrabold text-center border border-white"
                                                    >
                                            ...
                                            <tbody class="bg-white">
                                                <tr
                                                    v-for="(
                                                        variance, index
                                                    ) in sampleWithVariances"
                                                    :key="index"
                                                >
                                                    <td
                                                        class="px-[2px] py-[3px] text-[10px] text-center text-gray-700 border border-blue-500"
                                                    >
                                                        {{ variance }}
                                                    </td>
                                                </tr>
                                ...
                                <div class="flex flex-row">
                                    ...
                                    <div class="mb-16">
                                        ...
                                        >
                                            ...
                                            >
                                                <tr>
                                                    <th
                                                        v-for="secondTableLayerColumnHeader in secondTableLayerColumnHeaders"
                                                        :key="
                                                            secondTableLayerColumnHeader.name
                                                        "
                                                        class="px-[3px] py-[2px] text-[12px] font-medium text-center"
                                                    >
                                                        {{
                                                            secondTableLayerColumnHeader.name
                                                        }}
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td
                                                        class="px-[2px] py-[2px] text-[12px] font-extrabold text-center text-white bg-blue-700"
                                                    >
                                                        AVERAGE
                                                    </td>
                                                    <td
                                                        ...
                                                        :key="index"
                                                        class="px-[4px] py-[2px] text-[10px] text-center text-gray-700 border border-blue-500"
                                                    >
                                                        {{ aggAveValue.value }}
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td
                                                        class="px-[2px] py-[2px] text-[12px] font-extrabold text-center text-white bg-red-800"
                                                    >
                                                        NG&#160;COUNTER
                                                    </td>
                                                    <td
                                    ...
                                    <div
                                        class="flex flex-col items-center justify-center p-4 mb-4 ml-6 space-y-3 text-sm bg-blue-200 rounded-lg shadow-md"
                                    >
                                        <!-- DIV 6 -->
                                        ...
                                        <div>
                                            <p
                                                class="px-4 py-1 text-xs font-bold text-white bg-blue-900 rounded-md shadow"
                                            >
                                                Data Results:
                                            </p>
                                        </div>
                                        ...
                                        <div
                                            class="w-[600px] h-[50px] px-4 py-2 bg-white rounded-2xl text-xs space-y-1"
                                        >
                                            <p
                                                class="flex gap-1 font-bold whitespace-nowrap"
                                            >
                                                <span
                                                    v-for="(
                                                        rejectOKNGlist, index
                                                    ) in rejectOKNG"
                                                    :key="index"
                                                    :class="
                                                        adjustColor_rejectOKNG(
                                                            rejectOKNGlist,
                                                        )
                                                    "
                                                >
                                        ...
                                        <!-- Additional Info Row -->
                                        <div
                                            class="flex items-stretch justify-center w-full space-x-2"
                                        >
                                            <!-- iHc Remarks -->
                                            <div
                                                class="flex flex-col items-center justify-center w-1/2 px-4 py-2 text-center bg-white rounded-2xl"
                                            >
                                                <p
                                            ...
                                            <!-- Lot Remarks -->
                                            <div
                                                class="flex flex-wrap items-center justify-center w-1/2 px-4 py-2 text-xs font-bold bg-white rounded-2xl"
                                            >
                                                <span
                                                    v-for="(
                        ...
                        <div v-if="isSecAdditional" class="space-y-4">
                            ...
                            >
                                <label for="setSelect" class="font-medium"
                                    >Select Set:</label
                                >
                                <select
                                    id="setSelect"
                            ...
                            <div class="flex justify-center mt-5 space-x-4">
                                <!-- Chart -->
                                <div
                                    class="w-[600px] h-[480px] bg-gray-50 rounded-xl flex items-center justify-center pr-5 pl-5 border-2 border-blue-900"
                                >
                                    <img
                                ...
                                <!-- Side Content -->
                                <div
                                    class="w-[350px] h-[420px] bg-gray-50 rounded-xl border-2 border-blue-900 flex flex-col justify-start p-4"
                                >
                                    <div class="flex flex-col space-y-2">
                                        ...
                                        <p>
                                            Furnace Cycle No.:
                                            {{
                                                secAdd_propD_jhCurveFurnaceName
                                            }}
                                        </p>
                                        <p>
                                            <span>{{
                            ...
                            <!-- Data Table -->
                            <div
                                class="p-6 border-2 border-gray-500 rounded-lg shadow-lg bg-gray-50"
                            >
                                    ...
                                    <div class="min-w-[700px] shadow-2xl">
                                        ...
                                        >
                                            ...
                                            <tbody class="bg-white">
                                                ...
                                                >
                                                    <td
                                                        class="text-center text-[10px] border border-blue-500 px-[3px] py-[3px]"
                                                    >
                                                        {{ item.date }}
                                                    </td>
                                                    <td
                                                    ...
                                                    <td
                                                        class="text-center text-[10px] border border-blue-500 px-[0px] py-[3px]"
                                                    >
                                                        {{ item.furnace_no }}
                                                    </td>
                                                    <td
            ...
            <Modal
                :show="showModalUndoStamp"
                @close="showModalUndoStamp = false"
            >
                <div
                    class="relative flex flex-col items-start bg-gradient-to-br from-white via-cyan-50 to-teal-50 border-l-4 border-cyan-500 p-6 rounded-xl shadow-xl max-w-[95vw] max-h-[90vh] overflow-auto"
                >
                    <!-- Exit Button -->
                    <button
                    ...
                    <div class="flex items-center mb-4 space-x-3">
                        <div
                            class="flex items-center justify-center w-10 h-10 rounded-full bg-cyan-100"
                        >
                            <svg
                        ...
                        <h2
                            class="text-xl font-bold leading-snug text-cyan-800"
                        >
                            Undo {{ undoStampLabel }}
                        </h2>
                    </div>
                    ...
                    <p class="mb-4 text-sm leading-relaxed text-gray-700">
                        This action will remove the stamp permanently from the
                        report. Please provide a clear reason for logs tracking.
                    </p>
                    ...
                    <div class="flex justify-end w-full mt-6 space-x-3">
                        ...
                        <button
                            @click="undoStamp"
                            class="px-6 py-2 text-sm font-semibold text-white bg-gradient-to-r from-cyan-500 to-teal-500 rounded-lg shadow-md hover:from-cyan-600 hover:to-teal-600 hover:shadow-lg active:scale-[0.98] transition-all duration-200"
                        >
                            Confirm Undo
                        </button>
                    </div>
            ...
            <Modal
                :show="showModalUndoHistory"
                @close="showModalUndoHistory = false"
            >
                <div
                    class="relative flex flex-col items-start bg-gradient-to-br from-white via-cyan-50 to-teal-50 border-l-4 border-cyan-500 p-6 rounded-xl shadow-xl max-w-[95vw] max-h-[90vh] overflow-auto"
                >
                    ...
                    <div class="w-full space-y-4">
                        ...
                        <div
                            v-if="
                                !undoHistoryLoading && undoHistory.length === 0
                            "
                        ...
                        >
                            ...
                            <div
                                class="mt-1 text-sm text-gray-700 whitespace-break-spaces"
                            >
...
const vtStatus = computed(() => {
    ...
    const results = reportVT_iHcResults.value || [];
...
const isGXValid = computed(() => {
    const min = reportGX_iHcMinimum.value;
    const std = reportGX_iHcStandard.value;

    if (min === null || std === null) return null;

    return min >= std;
});

const gxJudgement = computed(() => {
    if (!isGXActive.value) return null;
    if (isGXValid.value === null) return null;

    if (!isGXValid.value) {
        return "REJECT";
    }

    if (specialModelsForGxFormat.value.includes(jhCurveActualModel.value)) {
        return "PASSED";
    }
...
const isBHValid = computed(() => {
    const results = reportBH_results.value;
    const standard = reportBH_dataStandard.value;

    if (!results || standard === null || standard === undefined) {
        return null;
    }
...
const bhJudgement = computed(() => {
    if (!isBHActive.value) return null;
    if (isBHValid.value === null) return null;
...
const isFromControlSheet = ref(false);
...
const reportBHRTSeg_remarks = computed(() =>
    reportBHRTSeg_results.some(
        (s) =>
            s < reportBHRTSeg_lower_dataStandard.value ||
            s > reportBHRTSeg_higher_dataStandard.value,
    )
        ? "NG"
        : "OK",
);
...
const reportBHSeg_remarks = computed(() =>
    reportBHSeg_results.some((s) => s <= reportBHSeg_dataStandard.value)
        ? "NG"
        : "OK",
);

const reportBHSeg_2nd_remarks = computed(() =>
    reportBHSeg_2nd_results.some((s) => s <= reportBHSeg_2nd_dataStandard.value)
        ? "NG"
        : "OK",
);

const reportBHSeg_3rd_remarks = computed(() =>
    reportBHSeg_3rd_results.some((s) => s <= reportBHSeg_3rd_dataStandard.value)
        ? "NG"
        : "OK",
);
...
const perform =
    "Perform additional samples from 2nd layer & beside the normal samples of all boxes.";
...
const adjustColor_rejectOKNG = (arrayString_OKNG) => {
    ...
    if (arrayString_OKNG && arrayString_OKNG.includes) {
        return arrayString_OKNG.includes("Status OK")
            ? "text-green-500"
            : "text-red-500";
    }
...
const adjustColor_rejectLotRemarks = (arrayString_lotRem) => {
    return arrayString_lotRem.includes("THIS LOT IS PASS")
        ? "text-green-600"
        : "text-red-500";
};
...
const adjustColor_rejectInstructions = computed(() => {
    ...
    return rejectInstruction.value &&
        rejectInstruction.value.includes("No reject instructions")
        ? "text-blue-600"
        : "text-green-500";
});
...
const adjustColor_rejectiHc = computed(() => {
    ...
    return rejectiHcRemarks.value &&
        rejectiHcRemarks.value.includes("iHc variance OK")
        ? "text-blue-600"
        : "text-red-500";
});
...
watchEffect(() => {
    ...
    if (data.length) {
        ...
        reportCoatingModuleAverage.value = (
...
watch(
    ...
    (val) => {
        ...
        if (reportVT_remarks.value !== val.remarks) {
            reportVT_remarks.value = val.remarks;
        }

        if (reportSMPJudgement.value !== val.judgement) {
...
watch(
    ...
    () => {
        ...
        if (
            ...
            reportCpkFrom_iHc_Cpk.value !== null
        ) {
...
const checkSpecialJudgement = async () => {
    ...
    // VT Data
    if (
        MODELS_SHOW_VT_DATA.value.includes(model) &&
...
const autoCheckRemarks = () => {
    ...
    if (
        reportiHcVariance.value > 1500 ||
        tpmDataQuantity.value > 5 ||
...
const fetchAllData = async () => {
    try {
        ...
        if (!rawData || !modelData?.length)
            throw new Error("TPM data missing or malformed.");
        ...
        fetchMaterialCode.value =
            modelData[0].code_no || throwError("Missing material code.");
        ...
        sampleWithVariances.value = calculateVariance(
            getAlliHcValues.value,
            maxiHc.value,
        );

        // Convert each item in sampleWithVariances to a string
        const sampleWithVariancesAsString =
            sampleWithVariances.value.map(String);
        ...
        if (
            ...
            rejectLotRemarks.value = rejectLotRemarks.value.filter(
                (rejectLot) => rejectLot !== lotReject + "  ",
            );
            rejectLotRemarks.value = rejectLotRemarks.value.filter(
                (rejectLot) => rejectLot !== lotHold + "  ",
            );
        ...
        showNotification2(
            "Data is incomplete for this serial. Please rerun the data.",
        );
        exitReport();
...
const fetchMiasFactor_category = async () => {
    try {
        const responseTPM = await axios.get(
            `/api/tpmdata?serial=${currentSerialSelected.value}`,
        );

        const tpmCat = responseTPM.data?.data?.[0]?.category;

        if (!tpmCat || tpmCat.factor_emp == null || tpmCat.mias_emp == null) {
...
const getSecAllSetsData = async () => {
    try {
        ...
        const response = await axios.get(
            "/api/nsadata?serial=" + currentSerialSelected.value,
        );
        ...
        if (!allNsaData.length) {
            isSecAdditional.value = false;
            toast.warning(
                "No SEC additional data detected for this serial number",
            );
            secDataBySet.value = {};
...
const nsa_showData = async (setNo = current_setNo.value) => {
    try {
        ...
        if (!setData.length) {
            console.warn(
                `No data found for serial ${currentSerialSelected.value} and set ${setNo}`,
            );
            nsaData.value = [];
        ...
        secAdd_propD_jhCurveFurnaceName.value =
            setData[0]?.sintering_furnace_no ?? "No data found";
        secAdd_propD_jhCurveCodeNo.value =
...
const setJudgmentFlags = (models) => {
    ...
    const primary =
        ...
        flag(getAllDensityNG.value) ||
        flag(getAlliHkiHcNG.value) ||
        flag(getAllBr4paiNG.value) ||
        flag(getAll4paildNG.value) ||
        flag(getAll4pailsNG.value) ||
        flag(getAll4pailaNG.value) ||
        flag(getAllbHcNG.value);

    if (primary) {
        reportRemarksDisplay.value = "E";
        reportSMPJudgement.value =
            flag(getAlliHcNG.value) ||
            flag(getAlliHkNG.value) ||
            flag(getAllBHMaxNG.value)
                ? "REJECT"
                : "HOLD";
    } else {
...
const parseAggregates = (raw) => {
    if (!raw.average || !raw.minimum || !raw.maximum)
        throwError("Missing average/min/max data.");
...
const matchInspectionModel = async (model) => {
    ...
    if (!found) {
        showNotification2(
            "The specified model does not exist in the inspection data. Please create the necessary inspection data first in the Inspection section of the website.",
        );
        showReportContent.value = false;
        showSelectionPanel.value = true;
...
const showReportData = async () => {
    try {
        ...
        if (noteRejectReasons && Array.isArray(noteRejectReasons)) {
            ...
            console.warn(
                "No valid noteRejectReasons found (null or not an array).",
            );
        }
        ...
        reportBrVariance.value =
            parseFloat(reportBrMaximum.value) -
            parseFloat(reportBrMinimum.value);
        reportiHcVariance.value =
            parseFloat(reportihcMaximum.value) -
            parseFloat(reportihcMinimum.value);
        reportiHkVariance.value =
        ...
        reportVT_sampleRemarks.value = Array.isArray(VT.sample_remarks)
            ? VT.sample_remarks
            : [];
        //console.log("reportVT_sampleRemarks:", reportVT_sampleRemarks.value);
        reportVT_iHcResults.value = Array.isArray(VT.iHcResult)
            ? VT.iHcResult
            : [];
        ...
        reportBHRTSeg_lower_dataStandard.value =
            bhSeg.dataRtLowerStandard || 1.38;
        reportBHRTSeg_higher_dataStandard.value =
            bhSeg.dataRtHigherStandard || 1.44;
        reportBHRTSeg_results.splice(
            0,
            reportBHRTSeg_results.length,
            ...(Array.isArray(bhSeg.resultRt) ? bhSeg.resultRt : []),
        );
        ...
        reportBHSeg_samples.value = Array.isArray(bhSeg.sample)
            ? bhSeg.sample
            : [];
        reportBHSeg_sampleQty.value = bhSeg.sample_qty ?? 0;
        reportBHSeg_temp.value = bhSeg.temp || 200;
        reportBHSeg_results.splice(
            0,
            reportBHSeg_results.length,
            ...(Array.isArray(bhSeg.result) ? bhSeg.result : []),
        );
        reportBHSeg_2nd_results.splice(
            0,
            reportBHSeg_2nd_results.length,
            ...(Array.isArray(bhSeg.result2nd) ? bhSeg.result2nd : []),
        );
        reportBHSeg_3rd_results.splice(
            0,
            reportBHSeg_3rd_results.length,
...
const saveReport = async () => {
    ...
    if (coatingCompleted.value == true) {
        await userReportLogging(
            `has successfully marked coating completed | serial ${currentSerialSelected.value}`,
        );
    }

    if (heatTreatmentCompleted.value == true) {
        await userReportLogging(
            `has successfully marked heat treatment completed | serial ${currentSerialSelected.value}`,
        );
    }
    ...
    for (let i = 0; i < 30; i++) {
        ...
        coatingData[`${i + 1}_${mLabel}_Amount`] =
            reportCoatingAmounts.value[i];
        coatingData[`${i + 1}_${mLabel}_Concentration`] =
            reportConcentrationValues.value[i];
    }
    ...
    for (let i = 0; i < 12; i++) {
        ...
        coatingData[`${groupStart}to${groupEnd}_M06_${i + 1}_Concentration`] =
            reportConcentrationValues.value[M06_START_INDEX + i];
    }
...
const saveReportUpdate = async (saveData, serial) => {
    try {
        const responseSave = await axios.patch(
            `/api/reportdata/${serial}`,
            saveData,
        );
...
const deleteNsaData = async () => {
    try {
        ...
        await axios.delete(
            `/api/tpmdata/${currentSerialSelected.value}/${current_setNo.value}/delete-nsa-chart`,
        );

        // Delete the database row
        await axios.delete(
            `/api/nsadata/${currentSerialSelected.value}/${current_setNo.value}`,
        );
        ...
        console.log(
            `[Row + Chart Deleted]: Serial ${currentSerialSelected.value} Set ${current_setNo.value}`,
        );
        userSerialDeleteLogging(
            `deleted Serial ${currentSerialSelected.value} set ${current_setNo.value} and its chart image`,
        );
    } catch (error) {
...
const undoStamp = async () => {
    try {
        ...
        await userReportLogging(
            `has successfully removed ${currentUndoType.value} by stamp | serial ${currentSerialSelected.value}`,
        );
...
const props = defineProps({
    ...
    fromControlSheet: [Boolean, String],
...
isFromApproval.value =
    props.fromApproval === true || props.fromApproval === "true";
isFromApproval_checked.value =
    props.fromApproval_checked === true ||
    props.fromApproval_checked === "true";
isFromApproval_prepared.value =
    props.fromApproval_prepared === true ||
    props.fromApproval_prepared === "true";
isFromViewList.value =
    props.fromViewList === true || props.fromViewList === "true";
isFromControlSheet.value =
    props.fromControlSheet === true || props.fromControlSheet === "true";
...
const preparedByStamp = async () => {
    try {
        ...
        console.error(
            "Error fetching report data by preparedByStamp function:",
            error,
        );
    }
};
...
const confirmPreparedByStamp = async () => {
    ...
    await userReportLogging(
        `has successfully stamped Prepared By of serial ${currentSerialSelected.value}`,
    );
    ...
    try {
        ...
        if (error.response) {
            ...
            console.error(
                "[ERROR] Email API request made but no response:",
                error.request,
            );
        } else {
...
const confirmCheckedByStamp = async () => {
    ...
    await userReportLogging(
        `has successfully stamped Checked By of serial ${currentSerialSelected.value}`,
    );
...
const addCarmark = async () => {
    try {
        const responseCarMark = await axios.patch(
            `/api/reportdata/${currentSerialSelected.value}`,
            {
                withCarmark: 1,
            },
    ...
    try {
        ...
        router.visit("/sec_additional", {
            ...
            data: {
                ...
                sec_massProd: sec_massprod,
                sec_layer: sec_layer,
                sec_furnace: sec_furnace,
            },
            preserveState: true,
            preserveScroll: true,
            onError: (errors) => {
