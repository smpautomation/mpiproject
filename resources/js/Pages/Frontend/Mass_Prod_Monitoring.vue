<template>
    <Frontend>
        ...
        >
            <div
                class="max-w-4xl p-6 mx-auto bg-white border border-gray-200 shadow-lg rounded-xl"
            >
                <!-- Header Section -->
                <div class="pb-4 mb-6 border-b-2 border-gray-200">
                    <div class="flex items-center gap-3 mb-4">
                        <div
                            class="w-1.5 h-10 bg-gradient-to-b from-teal-500 to-cyan-500 rounded-full"
                        ></div>
                        <div>
                            ...
                            >
                                Select a furnace + mass production below to view
                                real-time process completion status across all
                                layers
                            </p>
                        </div>
                    </div>
                ...
                <div v-if="massProductionData.length > 0" class="space-y-6">
                    <div v-for="mpc in massProductionData" :key="mpc.mass_prod">
                        <div class="flex items-center gap-2 mb-4">
                            ...
                            <span
                                class="px-3 py-1 text-xs font-semibold text-teal-700 border border-teal-200 rounded-full bg-gradient-to-r from-teal-100 to-cyan-100"
                            >
                                A total of {{ mpc.numberOfLotsWithData }} Lots
                                detected in this mass production
                            </span>
                        </div>
                            ...
                            >
                                ...
                                >
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="flex items-center justify-center w-10 h-10 font-bold text-white rounded-lg shadow-sm bg-gradient-to-br from-teal-500 to-cyan-500"
                                        >
                                            {{ layer.layer_no }}
                                        </div>
                                        <div>
                                ...
                                <div class="grid grid-cols-3 gap-3">
                                    ...
                                    >
                                        <div
                                            v-if="layer.mpi_completed"
                                            class="absolute flex items-center justify-center w-6 h-6 rounded-full shadow-md -top-2 -right-2 bg-cyan-600"
                                        >
                                            <svg
                                                class="w-4 h-4 text-white"
                                                fill="none"
                ...
                <div v-else class="py-12 text-center">
                    ...
                    <p class="font-medium text-gray-500">
                        Select a mass production to view progress
                    </p>
                </div>
            </div>
        </div>
