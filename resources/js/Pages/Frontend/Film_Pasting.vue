<template>
    <Frontend>
        ...
        <div
            class="flex flex-col items-center justify-center min-h-screen px-4 py-4 bg-gray-100"
        >
            <div
                v-if="
                ...
                >
                    ...
                    <div class="flex-1">
                        ...
                        <p class="mt-1 text-xs text-gray-600">
                            Choose from the dropdown above to view layer status
                            information.
                        </p>
                    </div>
                </div>
                    ...
                    >
                        <div class="flex items-center space-x-2">
                            ...
                            <h3 class="text-sm font-semibold text-white">
                                ...
                                {{ filmPastingInfo.selected_mass_prod }} Mass
                                Production )
                            </h3>
                        </div>
                    </div>
            ...
            <div class="flex flex-row gap-10 mt-10">
                ...
                >
                    <h2
                        class="pb-1 mb-10 font-bold text-gray-800 border-b text-md"
                    >
                        Film Pasting Information
                    </h2>
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                        <div class="relative">
                            ...
                            <select
                                ...
                                :disabled="
                                    isFilmPasteDataShown || isAdditionalMode
                                "
                    ...
                    >
                        ...
                        <div
                            v-if="lotNoLists.length > 1 && isInitialLotSaved"
                        ...
                        <p
                            v-if="isAdditionalMode"
                            class="mb-10 text-xs text-gray-600 whitespace-nowrap"
                        >
                            <strong>Instruction:</strong> Select the appropriate
                            lot number, then confirm your selection by clicking
                            the
                            <strong class="text-orange-600">Set New Lot</strong>
                            button.
                        </p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                        <div>
                            <label
                                class="block mb-1 text-xs font-medium text-gray-700"
                                >Film Pasting Date<span class="text-red-500">
                                    *</span
                                ></label
                            >
                            <input
                                :disabled="isFilmPasteDataShown"
                                v-model="filmPastingInfo.film_pasting_date"
                                type="date"
                                class="w-full text-xs border-gray-300 rounded-lg shadow-sm disabled:cursor-not-allowed disabled:bg-gray-100 focus:ring-blue-500 focus:border-blue-500"
                            />
                        </div>
                        <div>
                            <label
                                class="block mb-1 text-xs font-medium text-gray-700"
                                >Machine No<span class="text-red-500">
                                    *</span
                                ></label
                            >
                            <input
                                :disabled="isFilmPasteDataShown"
                                v-model="filmPastingInfo.machine_no"
                                @input="
                                    filmPastingInfo.machine_no =
                                        filmPastingInfo.machine_no.toUpperCase()
                                "
                                type="text"
                                class="w-full text-xs border-gray-300 rounded-lg shadow-sm disabled:cursor-not-allowed disabled:bg-gray-100 focus:ring-blue-500 focus:border-blue-500"
                            />
                        ...
                        <div>
                            <label
                                class="block mb-1 text-xs font-medium text-gray-700"
                                >Total Magnet Weight<span class="text-red-500">
                                    *</span
                                ></label
                            >
                            <input
                                :disabled="isFilmPasteDataShown"
                                v-model="filmPastingInfo.total_magnet_weight"
                                type="number"
                                class="w-full text-xs border-gray-300 rounded-lg shadow-sm disabled:cursor-not-allowed disabled:bg-gray-100 focus:ring-blue-500 focus:border-blue-500"
                            />
                        </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                        <div>
                            <label
                                class="block mb-1 text-xs font-medium text-gray-700"
                                >Loader Operator<span class="text-red-500">
                                    *</span
                                ></label
                            >
                            <input
                                :disabled="isFilmPasteDataShown"
                                v-model="filmPastingInfo.loader_operator"
                                @input="
                                    filmPastingInfo.loader_operator =
                                        filmPastingInfo.loader_operator.toUpperCase()
                                "
                                type="text"
                                class="w-full text-xs border-gray-300 rounded-lg shadow-sm disabled:cursor-not-allowed disabled:bg-gray-100 focus:ring-blue-500 focus:border-blue-500"
                            />
                        ...
                        <div>
                            <label
                                class="block mb-1 text-xs font-medium text-gray-700"
                                >Unloader Operator<span class="text-red-500">
                                    *</span
                                ></label
                            >
                            <input
                                :disabled="isFilmPasteDataShown"
                                v-model="filmPastingInfo.unloader_operator"
                                @input="
                                    filmPastingInfo.unloader_operator =
                                        filmPastingInfo.unloader_operator.toUpperCase()
                                "
                                type="text"
                                class="w-full text-xs border-gray-300 rounded-lg shadow-sm disabled:cursor-not-allowed disabled:bg-gray-100 focus:ring-blue-500 focus:border-blue-500"
                            />
                        ...
                        <div>
                            <label
                                class="block mb-1 text-xs font-medium text-gray-700"
                                >Checker Operator<span class="text-red-500">
                                    *</span
                                ></label
                            >
                            <input
                                :disabled="isFilmPasteDataShown"
                                v-model="filmPastingInfo.checker_operator"
                                @input="
                                    filmPastingInfo.checker_operator =
                                        filmPastingInfo.checker_operator.toUpperCase()
                                "
                                type="text"
                                class="w-full text-xs border-gray-300 rounded-lg shadow-sm disabled:cursor-not-allowed disabled:bg-gray-100 focus:ring-blue-500 focus:border-blue-500"
                            />
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                        <div>
                            <label
                                class="block mb-1 text-xs font-medium text-gray-700"
                                >Film Coating Amount<span class="text-red-500">
                                    *</span
                                ></label
                            >
                            <input
                                :disabled="isFilmPasteDataShown"
                                v-model="filmPastingInfo.film_coating_amount"
                                @input="
                                    filmPastingInfo.film_coating_amount =
                                        filmPastingInfo.film_coating_amount.toUpperCase()
                                "
                                type="text"
                                class="w-full text-xs border-gray-300 rounded-lg shadow-sm disabled:cursor-not-allowed disabled:bg-gray-100 focus:ring-blue-500 focus:border-blue-500"
                            />
                        ...
                        <div>
                            ...
                            <input
                                :disabled="isFilmPasteDataShown"
                                v-model="filmPastingInfo.time_start"
                                type="time"
                                class="w-full text-xs border-gray-300 rounded-lg shadow-sm disabled:cursor-not-allowed disabled:bg-gray-100 focus:ring-blue-500 focus:border-blue-500"
                            />
                        </div>
                        <div>
                            ...
                            <input
                                :disabled="isFilmPasteDataShown"
                                v-model="filmPastingInfo.time_finished"
                                type="time"
                                class="w-full text-xs border-gray-300 rounded-lg shadow-sm disabled:cursor-not-allowed disabled:bg-gray-100 focus:ring-blue-500 focus:border-blue-500"
                            />
                        </div>
                    ...
                    <div>
                        ...
                        <input
                            :disabled="isFilmPasteDataShown"
                            v-model="filmPastingInfo.remarks"
                            @input="
                                filmPastingInfo.remarks =
                                    filmPastingInfo.remarks.toUpperCase()
                            "
                            type="text"
                            class="w-full text-xs border-gray-300 rounded-lg shadow-sm disabled:cursor-not-allowed disabled:bg-gray-100 focus:ring-blue-500 focus:border-blue-500"
                        />
                ...
                >
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-1">
                        <div>
                            <label
                                class="block mb-1 text-xs font-medium text-gray-700"
                                >Film Type (Tb or Dy)<span class="text-red-500">
                                    *</span
                                ></label
                            >
                            <input
                                ...
                                @input="
                                    filmPastingInfo.film_type =
                                        filmPastingInfo.film_type.toUpperCase()
                                "
                                type="text"
                                class="w-full text-xs border-gray-300 rounded-lg shadow-sm disabled:cursor-not-allowed disabled:bg-gray-100 focus:ring-blue-500 focus:border-blue-500"
                            />
                        ...
                        <div>
                            <label
                                class="block mb-1 text-xs font-medium text-gray-700"
                                >Film Class<span class="text-red-500">
                                    *</span
                                ></label
                            >
                            <input
                                :disabled="isFilmPasteDataShown"
                                v-model="filmPastingInfo.film_class"
                                @input="
                                    filmPastingInfo.film_class =
                                        filmPastingInfo.film_class.toUpperCase()
                                "
                                type="text"
                                class="w-full text-xs border-gray-300 rounded-lg shadow-sm disabled:cursor-not-allowed disabled:bg-gray-100 focus:ring-blue-500 focus:border-blue-500"
                            />
                ...
                <div class="flex flex-col gap-10 mt-5">
                    ...
                    >
                        ...
                        <div>
                            <label
                                class="block mb-1 text-xs font-medium text-gray-700"
                                >Sprayer Water amount</label
                            >
                            <input
                                :disabled="isFilmPasteDataShown"
                                v-model="
                                    filmPastingInfo.h_line_parameters[
                                        'sprayer_water_amount'
                                    ]
                                "
                                type="number"
                                class="w-full text-xs border-gray-300 rounded-lg shadow-sm disabled:cursor-not-allowed disabled:bg-gray-100 focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                "
                                type="text"
                                class="w-full mt-2 text-xs border-gray-300 rounded-lg shadow-sm disabled:cursor-not-allowed disabled:bg-gray-100 focus:ring-blue-500 focus:border-blue-500"
                            />
                        </div>
                        <div>
                            <label
                                class="block mb-1 text-xs font-medium text-gray-700"
                                >Film machine Humidity %</label
                            >
                            <input
                                :disabled="isFilmPasteDataShown"
                                v-model="
                                    filmPastingInfo.h_line_parameters[
                                        'film_machine_humidity'
                                    ]
                                "
                                type="number"
                                class="w-full text-xs border-gray-300 rounded-lg shadow-sm disabled:cursor-not-allowed disabled:bg-gray-100 focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div>
                            <label
                                class="block mb-1 text-xs font-medium text-gray-700"
                                >Film machine temperature</label
                            >
                            <input
                                :disabled="isFilmPasteDataShown"
                                v-model="
                                    filmPastingInfo.h_line_parameters[
                                        'film_machine_temperature'
                                    ]
                                "
                                type="number"
                                class="w-full text-xs border-gray-300 rounded-lg shadow-sm disabled:cursor-not-allowed disabled:bg-gray-100 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div class="flex flex-row gap-20 mt-10">
                <div
                    class="bg-gradient-to-br from-black via-gray-900 to-gray-800 border border-cyan-600 shadow-[0_10px_25px_rgba(99,102,241,0.4),0_4px_6px_rgba(0,0,0,0.4)] rounded-3xl px-6 py-6 flex items-center gap-16 ring-1 ring-teal-400 backdrop-blur-md whitespace-nowrap"
                >
                    ...
                    >
                        <div class="mb-6 text-center">
                            ...
                            <p class="text-sm font-semibold text-red-700">
                                This action is
                                <span class="underline">irreversible</span>!
                        ...
                        >
                            ...
                            <div class="space-y-2 text-xs text-red-800">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    ></div>
                                    <span
                                        >Submission is permanent. Proceed only
                                        if confident!</span
                                    >
                                </div>
                            </div>
...
const canSubmitAdditional = computed(() => {
    return (
        ...
        currentInitialLot.value != filmPasteLotNo.value
    );
});
...
const submit = async () => {
    if (!bypassValidation.value) {
        if (
            ...
            toast.error(
                "Please fill in all required Film Pasting Info fields.",
            );
            return;
        } else if (!filmPastingInfo.is_setter_sand) {
...
const updateFormatType = async () => {
    // Update format type of Mass Productions Table
    const layerKey =
        filmPastingInfo.selected_layer === "9.5"
            ? "layer_9_5_format_type"
            : `layer_${filmPastingInfo.selected_layer}_format_type`;
    ...
    try {
        const responseUpdate = await axios.patch(
            `/api/mass-production/${filmPastingInfo.selectedFurnace}/${filmPastingInfo.selected_mass_prod}`,
            dataPayload,
        );
...
const triggerAdditional = () => {
    if (
        ...
        if (!filmPastingInfo.selected_mass_prod)
...
const getCompletedLayers = async () => {
    try {
        const response = await axios.get(
            `/api/film-pasting-data/${filmPastingInfo.selectedFurnace}/${filmPastingInfo.selected_mass_prod}/layers`,
        );
...
const fetchFilmPastingDataSummary = async () => {
    try {
        const response = await axios.post(
            "/api/initial-film-pasting/fetch-film-paste-data",
            {
                lot_no: filmPasteLotNo.value,
        ...
        filmPastingInfo.total_magnet_weight =
            filmPaste.total_magnet_weight ?? 0;
        ...
        if (filmPaste.h_line_parameters) {
            filmPastingInfo.h_line_parameters.sprayer_water_amount =
                filmPaste.h_line_parameters.sprayer_water_amount ?? 0;
            filmPastingInfo.h_line_parameters.film_paste_lot_no_1 =
                filmPaste.h_line_parameters.film_paste_lot_no_1 ?? 0;
            filmPastingInfo.h_line_parameters.film_paste_lot_no_2 =
                filmPaste.h_line_parameters.film_paste_lot_no_2 ?? 0;
            filmPastingInfo.h_line_parameters.film_machine_humidity =
                filmPaste.h_line_parameters.film_machine_humidity ?? 0;
            filmPastingInfo.h_line_parameters.film_machine_temperature =
                filmPaste.h_line_parameters.film_machine_temperature ?? 0;
            filmPastingInfo.h_line_parameters.dryer_temp_setting =
                filmPaste.h_line_parameters.dryer_temp_setting ?? "";
        }

        // --- T Line ---
        if (filmPaste.t_line_parameters) {
            filmPastingInfo.t_line_parameters.sprayer_water_amount =
                filmPaste.t_line_parameters.sprayer_water_amount ?? 0;
            filmPastingInfo.t_line_parameters.film_paste_lot_no_1 =
                filmPaste.t_line_parameters.film_paste_lot_no_1 ?? 0;
            filmPastingInfo.t_line_parameters.film_paste_lot_no_2 =
                filmPaste.t_line_parameters.film_paste_lot_no_2 ?? 0;
            filmPastingInfo.t_line_parameters.film_machine_humidity =
                filmPaste.t_line_parameters.film_machine_humidity ?? 0;
            filmPastingInfo.t_line_parameters.film_machine_temperature =
                filmPaste.t_line_parameters.film_machine_temperature ?? 0;
            filmPastingInfo.t_line_parameters.dryer_temp_setting =
                filmPaste.t_line_parameters.dryer_temp_setting ?? "";
        }
