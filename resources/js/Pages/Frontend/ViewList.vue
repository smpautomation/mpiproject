                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="p-[1px]">
                                ...
                                >
                                    {{
                                        item.category[0].tpm_data_serial ||
                                        "NO DATA"
                                    }}
                                </div>
                            </td>
                            ...
                            <td class="p-[1px]">
                                ...
                                >
                                    {{
                                        item.tpm[0].sintering_furnace_no ||
                                        "NO DATA"
                                    }}
                                </div>
                            </td>
                            ...
                            <td class="p-[1px]">
                                ...
                                >
                                    {{
                                        item.report[0]?.approved_by_firstname
                                            ? "COMPLETED"
                                            : "PENDING"
                                    }}
                                </div>
                                ...
                                <div
                                    ...
                                    :class="{
                                        'bg-green-100 text-green-800':
                                            item.report[0]?.is_emailed,
                                        'bg-blue-100 text-blue-800':
                                            item.report[0]?.is_finalized &&
                                            !item.report[0]?.is_emailed,
                            ...
                            >
                                <!-- New Cell -->
                                <div
                                    class="flex flex-row justify-center px-0 py-1 text-sm text-center bg-white rounded-sm space-x-7 whitespace-nowrap"
                                >
                                    <div>
                                        <button
                                            @click="
...
const filteredData = computed(() => {
    ...
    return tpmData.value.filter((item) => {
        ...
        const matchesQuery =
            !query || model.includes(query) || lot.includes(query);
