        ...
        >
            ...
            >
                <div class="grid grid-cols-1 gap-6 mb-10 md:grid-cols-3">
                    ...
                    <div>
                        <label
                            class="block mb-2 text-sm font-medium text-gray-700"
                            >Layer<span class="text-red-500"> *</span></label
                        >
                        <select
                            v-model="currentLayerNo"
                            class="w-full px-4 py-3 text-sm font-medium text-gray-800 transition-all duration-200 bg-white border border-teal-300 rounded-lg shadow-sm focus:ring-2 focus:ring-teal-500 focus:border-teal-500 hover:border-teal-400"
                        >
                            <option
                                v-for="item in available_layers"
                                :key="item"
                                :value="item"
                            >
                                {{ item }}
                ...
                >
                    Please select and upload TPM files:
                </p>
                <div
                    v-show="showUploadData"
                    class="flex flex-row items-center justify-center"
                >
                    <div
                        v-show="showUploadTPMFiles"
                        class="max-w-lg mx-auto mb-12 overflow-hidden bg-white border border-gray-200 shadow-xl rounded-2xl"
                    >
                        <!-- Header -->
                        <div
                            class="px-6 py-4 bg-gradient-to-r from-teal-600 to-cyan-600"
                        >
                            <div class="flex items-center space-x-3">
                                <div
                                    class="flex items-center justify-center w-10 h-10 bg-white bg-opacity-20 rounded-xl backdrop-blur-sm"
                                >
                                    <svg
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-cyan-100">
                                        Select your .tpm files for processing
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="relative">
                                ...
                                <div
                                    class="p-8 text-center transition-all duration-200 border-2 border-gray-300 border-dashed rounded-xl hover:border-teal-400 hover:bg-teal-50 group"
                                >
                                    <!-- Upload Icon -->
                                    <div
                                        class="flex items-center justify-center w-16 h-16 mx-auto mb-4 transition-transform bg-gradient-to-br from-teal-100 to-cyan-100 rounded-2xl group-hover:scale-110"
                                    >
                                        <svg
                                    ...
                                    <!-- File Type Badge -->
                                    <div
                                        class="inline-flex items-center px-3 py-1 text-xs font-medium text-teal-800 bg-teal-100 rounded-full"
                                    >
                                        <svg
                                            class="w-3 h-3 mr-1"
                                            fill="currentColor"
                                ...
                                >
                                    <span class="flex items-center space-x-2">
                                        ...
                                        >
                                            ...
                                            <path
                                                fill-rule="evenodd"
                                                d="M4 5a2 2 0 012-2h8a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 3a1 1 0 000 2h6a1 1 0 100-2H7z"
                                                clip-rule="evenodd"
                                            />
                                        </svg>
                    ...
                    <div class="flex flex-col items-center space-y-6">
                        <div
                            v-show="showUploadTPMFiles"
                            class="max-w-lg mx-auto ml-10 overflow-hidden bg-white border border-gray-200 shadow-xl rounded-2xl"
                        >
                            <!-- Header -->
                            <div
                                class="px-6 py-4 bg-gradient-to-r from-cyan-600 to-teal-600"
                            >
                                <div class="flex items-center justify-between">
                                    ...
                                    <div
                                        ...
                                        class="px-3 py-1 bg-white rounded-full bg-opacity-20"
                                    >
                                        <span
                                            class="text-sm font-semibold text-white"
                                            >{{ fileLists.length }} files</span
                                        >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-6">
                                ...
                                >
                                    <div class="space-y-3">
                                        ...
                                        >
                                            <!-- File Icon and Name -->
                                            <div
                                                class="flex items-center flex-1 min-w-0 space-x-3"
                                            >
                                                <div
                                                    class="flex items-center justify-center flex-shrink-0 w-8 h-8 rounded-lg bg-gradient-to-br from-teal-500 to-cyan-500"
                                                >
                                                    <svg
                                ...
                                >
                                    <div
                                        class="flex items-center justify-center w-16 h-16 mb-4 bg-gray-100 rounded-2xl"
                                    >
                                        <svg
                                    ...
                                    <p
                                        class="max-w-xs text-sm leading-relaxed text-gray-500"
                                    >
                                        Upload some .tpm files to see them
                        ...
                        <div
                            ...
                            class="w-[380px] ml-10 p-5 mx-auto space-y-4 text-white shadow-lg bg-gradient-to-br from-cyan-500 to-teal-600 rounded-2xl text-center"
                        >
                            <!-- SET -->
                            <div
                                class="text-xs font-semibold tracking-widest uppercase opacity-90"
                            >
                                Select Set
                            </div>
                            <select
                            ...
                            <div class="text-lg font-bold">
                                ...
                                <template v-else>
                                    <span
                                        class="text-sm font-normal text-white/70"
                                    >
                        ...
                        <div
                            v-else
                            class="w-[370px] ml-10 p-4 mx-auto space-y-2 text-white shadow-md bg-gradient-to-r from-cyan-500 to-teal-600 rounded-xl text-center"
                        >
                            <!-- Model -->
                            <div
                                class="text-sm font-medium tracking-wide uppercase opacity-80"
                            >
                                Model
                            </div>
                            <div class="text-lg font-bold">
                            ...
                            <!-- Lot No -->
                            <div
                                class="mt-2 text-sm font-medium tracking-wide uppercase opacity-80"
                            >
                                Lot No
                            </div>
                            <div class="text-lg font-bold">
                                ...
                                <template v-else>
                                    <span class="font-normal text-gray-200"
                                        >Please select Mass Production and
                                        Layer</span
                                    >
                                </template>
                            </div>
                ...
                <div>
                    <div
                        class="flex flex-col items-center justify-center max-w-lg p-8 mx-auto mt-5 mb-12 bg-white border border-teal-200 shadow-xl rounded-xl"
                    >
                        <!-- Upload Section Title -->
                        <div class="flex items-center mb-6">
                            <div
                                class="p-3 mr-3 rounded-full bg-gradient-to-r from-teal-100 to-cyan-100"
                            >
                                <svg
                                ...
                                {{
                                    (lotNoLists?.length || 0) > 1
                                        ? !additionalModel || !additionalLot
                                            ...
                                            : isAdditionalExisting
                                              ? "This set already exists in the system"
                                              : "Generate Graph"
                                        : !isModelLotNoVerified
                ...
                <p
                    v-if="mias_factorCsvError"
                    class="font-extrabold text-red-500 font-lg"
                >
                    Error: Data in the uploaded Property Data csv file does not
                    exist in the Mias Factor Data list.
                </p>
            </div>
            ...
            <div v-show="showGraphAndTables" class="z-10 flex flex-col">
                <div class="flex flex-col items-center justify-center">
                    <p
                        class="px-4 py-2 text-xl text-white border-2 shadow-lg animate-pulse rounded-xl bg-gradient-to-br from-cyan-900/80 to-green-100/40 backdrop-blur-lg"
                    >
                        Note: You may now proceed to the
                ...
                <div class="flex flex-row justify-center mt-5 space-x-4">
                    ...
                    >
                        <div class="flex flex-col items-start space-y-2">
                            ...
                            <p>Furnace Cycle No. : {{ jhCurveFurnaceName }}</p>
                            <p>
                            ...
                            <p class="font-semibold text-red-600">
                                <template
                                    v-if="
                                        fetchNoteReasonForReject &&
                                        fetchNoteReasonForReject.length
                                    "
                                >
                                ...
                                <template v-else>
                                    <span class="text-xs italic text-gray-400">
                                        Reject remarks will appear here once the
                                        report data has been saved, if any
                                        exist.
                                    </span>
                                </template>
                            </p>
                ...
                >
                    ...
                    <div class="flex flex-row justify-center">
                        <p class="mr-10">
                            Mias. Employee: <span>{{ propData_miasEmp }}</span>
                        </p>
                        <p>
                            Factor Employee:
                            <span>{{ propData_factorEmp }}</span>
                        </p>
                    </div>
                    <div class="flex flex-col items-center justify-center">
            ...
            >
                <div class="relative">
                    ...
                    <div
                        class="relative px-6 py-6 text-white bg-gradient-to-r from-red-600 via-orange-600 to-red-700 rounded-t-xl"
                    >
                        <!-- Icon -->
                        <div
                            class="flex items-center justify-center w-12 h-12 mb-2 bg-white bg-opacity-25 border border-white rounded-xl backdrop-blur-sm border-opacity-40"
                        >
                            <svg
                                class="w-6 h-6 text-white"
                                fill="currentColor"
                            ...
                            >
                                <path
                                    fill-rule="evenodd"
                                    d="M8.257 3.099c.765-1.36 2.68-1.36 3.445 0l7.097 12.624c.75 1.334-.213 2.977-1.723 2.977H2.883c-1.51 0-2.473-1.643-1.723-2.977L8.257 3.1zM11 13a1 1 0 10-2 0 1 1 0 002 0zm-1-7a1 1 0 00-.993.883L9 7v4a1 1 0 001.993.117L11 11V7a1 1 0 00-1-1z"
                                    clip-rule="evenodd"
                                />
                            </svg>
                        </div>
                    ...
                    <!-- Main content -->
                    <div
                        class="px-6 py-6 space-y-4 text-center border border-red-300 bg-red-50 rounded-b-xl"
                    >
                        <p class="text-lg font-semibold text-red-800">
                            ⚠️ Please double-check the MIAS and Factor employee
                            numbers at CSV file before uploading. Errors here
                            can cause serious data issues.
                        </p>

                        <p class="text-sm text-red-700">
                            Ensure the information is accurate. Only continue
...
const fetchAllSets = async () => {
    try {
        const { data } = await axios.get(
            "/api/breaklot-initial-lots/show-all",
            {
                params: {
...
const checkExisting = async () => {
    try {
        const response = await axios.get(
            `/api/tpm/check-existing/${selectedFurnace.value}/${selectedMassProd.value}/${currentLayerNo.value}`,
        );
...
const checkExistingAdditional = async () => {
    try {
        const response = await axios.get(
            "/api/breaklot-coating/check-existing-tpm",
            {
                params: {
                    mass_prod: selectedMassProd.value,
                    furnace: selectedFurnace.value,
...
// Watcher go back
watch(
    [selectedMassProd, currentLayerNo, selectedFurnace],
    async ([newProd, newLayer, newFurnace]) => {
...
const mias_factorData = async (factor, mias) => {
    ...
    const findByEmpOrMiasNo = (searchValue) => {
        ...
        const empMatch = miasFactorData.find(
            (item) => item.employee_no === searchValue,
        );
        if (empMatch) {
...
const generateSerialNumber = async () => {
    try {
        ...
        const monthlySerials = tpmData
            ...
            .filter((serial) => serial && serial.startsWith(currentPrefix));
        ...
        return new Promise((resolve, reject) => {
            ...
            reader.onload = async () => {
                ...
                const layerData = {
                    ...
                    BHMax:
                        parseFloat(parseFloat(rowCell.value[15]).toFixed(2)) ||
                        0,
                    Squareness:
                        parseFloat(parseFloat(rowCell.value[16]).toFixed(3)) ||
                        0,
...
const saveToTpmCategory = async () => {
    try {
        const responsePatchCategory = await axios.patch(
            `/api/updatecategory/${serialNo.value}`,
            {
...
const showAllData = async () => {
    const fromAnotherPage = Object.values(props).some(
    ...
    try {
        ...
        jhCurveFurnaceName.value =
            tpmData.value[0].sintering_furnace_no || "No data found";
        ...
        getAllBrValues.value = combinedData.value.map(
            (item) => item.Br || null,
        );
        getAllBrRemarks.value = combinedData.value.map(
            (item) => item.remark.Br_remarks || null,
        );
        getAlliHcValues.value = combinedData.value.map(
            (item) => item.iHc || null,
        );
        getAlliHcRemarks.value = combinedData.value.map(
            (item) => item.remark.iHc_remarks || null,
        );
        getAlliHkValues.value = combinedData.value.map(
            (item) => item.iHk || null,
        );
        getAlliHkRemarks.value = combinedData.value.map(
            (item) => item.remark.iHk_remarks || null,
        );
        getAllBHMaxValues.value = combinedData.value.map(
            (item) => item.BHMax || null,
        );
        getAllBHMaxRemarks.value = combinedData.value.map(
            (item) => item.remark.BHMax_remarks || null,
        );
        getAlliHr95Values.value = combinedData.value.map(
            (item) => item.iHr95 || null,
        );
        getAlliHr95Remarks.value = combinedData.value.map(
            (item) => item.remark.iHr95_remarks || null,
        );
        getAlliHr98Values.value = combinedData.value.map(
            (item) => item.iHr98 || null,
        );
        getAlliHr98Remarks.value = combinedData.value.map(
            (item) => item.remark.iHr98_remarks || null,
        );
        getAlliHciHkValues.value = combinedData.value.map(
            (item) => item.iHkiHc || null,
        );
        getAlliHciHkRemarks.value = combinedData.value.map(
            (item) => item.remark.iHkiHc_remarks || null,
        );
        getAllBr4paiValues.value = combinedData.value.map(
            (item) => item.Br4pai || null,
        );
        getAllBr4paiRemarks.value = combinedData.value.map(
            (item) => item.remark.Br4pai_remarks || null,
        );
        getAllbHcValues.value = combinedData.value.map(
            (item) => item.bHc || null,
        );
        getAllbHcRemarks.value = combinedData.value.map(
            (item) => item.remark.bHc_remarks || null,
        );
        getAllSquarenessValues.value = combinedData.value.map(
            (item) => item.Squareness || null,
        );
        getAllSquarenessRemarks.value = combinedData.value.map(
            (item) => item.remark.Squareness_remarks || null,
        );
        getAll4paildValues.value = combinedData.value.map(
            (item) => item["4paiId"] || null,
        );
        getAll4paildRemarks.value = combinedData.value.map(
            (item) => item.remark["4paiId_remarks"] || null,
        );
        getAll4pailsValues.value = combinedData.value.map(
            (item) => item["4paiIs"] || null,
        );
        getAll4pailsRemarks.value = combinedData.value.map(
            (item) => item.remark["4paiIs_remarks"] || null,
        );
        getAll4pailaValues.value = combinedData.value.map(
            (item) => item["4paiIa"] || null,
        );
        getAll4pailaRemarks.value = combinedData.value.map(
...
const sendAggData = async (aggData, id) => {
    // Make sure to pass 'id' as a parameter
    try {
        // Correct string interpolation for the URL
        const response = await axios.patch(
            `/api/tpmaggregateupdate/${id}`,
            aggData,
        ); // Proper string interpolation for URL
        // Uncomment this to see the response
        //console.log('API Response sendAggData:', response.data);
    } catch (error) {
        console.error(
            "Error sending aggregate data to API:",
            error.response?.data || error.message,
        );
    }
};
