    ...
    <nav class="top-0 left-0 right-0 z-50 w-full bg-white border-b border-gray-200 shadow-sm dark:bg-gray-900 dark:border-gray-700">
      <div class="flex flex-wrap items-center justify-center max-w-screen-xl px-4 py-3 mx-auto gap-x-10 gap-y-2 md:px-6">
        ...
        <div class="hidden md:flex md:items-center md:w-auto" id="navbar-default">
            ...
            <!-- Logo + Title -->
            <div v-if="state.isAuthenticated" class="flex items-center space-x-4 md:mr-10">
            <img src="photo/smp_logo.png" class="h-9" alt="SMP Logo" />
                <span class="text-xl font-bold text-gray-800 dark:text-white whitespace-nowrap">
                    MPI <span class="text-gray-500">Online</span> <span class="text-gray-300">System</span>
                </span>
            </div>
...
const navItems = [
  ...
  { label: 'MPI', route: 'manage', access: ['Basic User', 'Preparation Approver', 'Checking Approver', 'Hybrid Approver', 'Bypass Approver', 'Proxy Approver', 'Automation'] },
  ...
  { label: 'View List', route: 'viewList', access: ['Basic User', 'Preparation Approver', 'Checking Approver', 'Hybrid Approver', 'Bypass Approver', 'Proxy Approver', 'Automation', 'Coating', 'Heat Treatment'] },
